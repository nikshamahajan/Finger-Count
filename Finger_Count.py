...
Original file is located at
    https://colab.research.google.com/drive/1FCM0CGQq6NZX2SSGqBNiNBa8QBiFtny0
"""
...
def cal_accum_avg(frame,accumulated_weight):
  ...
  if background is None:
    ...
    cv2.accumulateWeighted(frame,backgraound,accumulated_weight)
...
while True:
  ...
  if num_frames<60:
    ...
    if hand is not None:
      ...
      finger=count_fingers(thresholded,hand_segment)
